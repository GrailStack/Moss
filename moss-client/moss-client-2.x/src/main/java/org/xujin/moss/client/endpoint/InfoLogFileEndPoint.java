...
@RestControllerEndpoint(id = "infoLogFile")
public class InfoLogFileEndPoint {
    ...
    public void invoke(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        InfoLogFileEndPoint.Handler handler = new InfoLogFileEndPoint.Handler(resource, request.getServletContext());
