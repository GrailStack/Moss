...
import org.xujin.moss.config.AdminEndpointApplicationRunListener;
...
@ConfigurationProperties(prefix = "endpoints.infoLogFile")
public class InfoLogFileEndPoint extends AbstractNamedMvcEndpoint {
    ...
    private static final Log logger = LogFactory.getLog(InfoLogFileEndPoint.class);

    public InfoLogFileEndPoint() {
        super("infoLogFile", AdminEndpointApplicationRunListener.SPRINGBOOT_MANAGEMENT_CONTEXT_PATHY_VALUE+"/infoLogFile", true);
    }
    ...
    public void invoke(HttpServletRequest request, HttpServletResponse response)
        ...
        Resource resource = getLogFileResource(logFile_type_info);
