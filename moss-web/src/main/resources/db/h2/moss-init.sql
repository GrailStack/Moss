...
CREATE TABLE `t_app` (
  ...
  `gmt_create` timestamp NOT NULL DEFAULT '1970-01-02 00:00:00' ,
...
CREATE TABLE `t_user_app` (
  `id` bigint(20)NOT NULL AUTO_INCREMENT ,
  `mail_nick_name` varchar(200) NOT NULL DEFAULT '' ,
...
INSERT INTO `t_user_app` VALUES
('38', 'xujin', 'halo-moss', '2019-03-10 05:46:39', '2019-04-05 01:31:23', '1'),
...
INSERT INTO `t_user_roles` VALUES
 ('11', 'admin', 'ADMIN', '2019-03-06 20:24:51', '2019-03-07 16:27:54', '0'),
